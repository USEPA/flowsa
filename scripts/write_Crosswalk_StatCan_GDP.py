...
if __name__ == '__main__':
    ...
    df = df.append(pd.DataFrame([['StatCan_GDP', '31-33', '32']], columns=['ActivitySourceName', 'Activity', 'Sector']))
    df = df.append(pd.DataFrame([['StatCan_GDP', '31-33', '33']], columns=['ActivitySourceName', 'Activity', 'Sector']))
    # drop 'Other' and nan
    ...
    # save as csv
    df.to_csv(datapath + "activitytosectormapping/" + "Crosswalk_StatCan_GDP.csv", index=False)
