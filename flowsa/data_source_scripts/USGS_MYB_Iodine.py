...
SourceName: USGS_MYB_Iodine
https://www.usgs.gov/centers/nmic/iodine-statistics-and-information

Minerals Yearbook, xls file, tab T1

Data for: Iodine; concentrate
...
def usgs_iodine_call(url, usgs_response, args):
    """
