...
import pandas as pd
import numpy as np
from flowsa.common import US_FIPS, fba_default_grouping_fields, flow_by_activity_mapped_wsec_fields
...
def bls_clean_allocation_fba_w_sec(df_w_sec, **kwargs):
    ...
    df2 = add_missing_flow_by_fields(df_w_sec,
                                     flow_by_activity_mapped_wsec_fields).reset_index(drop=True)
