...
setup(
    ...
    install_requires=[
        ...
        'esupy @ git+https://github.com/USEPA/esupy@v0.1.1@v0.1.1#egg=esupy',
        'StEWI @ git+https://github.com/USEPA/standardizedinventories@v0.9.6#egg=StEWI@v0.9.6#egg=StEWI',
        'pandas>=1.1.0',
        'pip>=9',
        'setuptools>=41',
        'pyyaml>=5.3',
